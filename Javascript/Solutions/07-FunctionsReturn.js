...
function funRet3() {
    /*
        Write a method "addThousand" that returns a value that adds thousen to the number 
...
function funRetExtra1() {
    ...
    */
    ...
    console.log(`Number of years to retirement: ${timeUntilRetirement(43)}`);
    console.log(`Number of years to retirement: ${timeUntilRetirement(20)}`);
    console.log(`Number of years to retirement: ${timeUntilRetirement(68)}`);
    console.log(`Number of years to retirement: ${timeUntilRetirement(100)}`);
